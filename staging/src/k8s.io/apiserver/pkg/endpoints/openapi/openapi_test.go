...
func TestGetDefinitionName(t *testing.T) {
	testType := TestType{}
	typePkgName := "k8s.io/kubernetes/staging/src/k8s.io/apiserver/pkg/endpoints/openapi.TestType"
	typeFriendlyName := "io.k8s.kubernetes.staging.src.k8s.io.apiserver.pkg.endpoints.openapi.TestType"
